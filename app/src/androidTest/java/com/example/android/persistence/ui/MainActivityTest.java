...
import com.thv.android.trackme.EspressoTestUtil;
...
public class MainActivityTest {
    ...
    public void clickOnFirstItem_opensComments() throws Throwable {
        drain();
        // When clicking on the first workout
        onView(ViewMatchers.withContentDescription(R.string.cd_workouts_list))
        ...
        drain();
        // Then the second screen with the comments should appear.
        onView(withContentDescription(R.string.cd_workout_name))
